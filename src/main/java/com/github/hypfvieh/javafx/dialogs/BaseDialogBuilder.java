 ...
 *
 * @author hypfvieh
 * @since v11.0.4 - 2025-08-31
 */
public abstract class BaseDialogBuilder<D extends BaseDialogBuilder<D>> {
     ...
     * @return this
     */
    public D withType(AlertType _type) {
        type = _type;
        return self();
    }
     ...
     * @return this
     */
    public D withTitle(String _title) {
        title = _title;
        return self();
    }
     ...
     * @return this
     */
    public D withSubTitle(String _subTitle) {
        subTitle = _subTitle;
        return self();
    }
     ...
     * @return this
     */
    public D withMessage(String... _msg) {
     ...
     */
    public D withButton(ButtonData _button, String _caption) {
     ...
     * @return this
     */
    public D withYesButton(String _caption) {
     ...
     * @return this
     */
    public D withNoButton(String _caption) {
     ...
     * @return this
     */
    public D withCancelButton(String _caption) {
     ...
     */
    public D withDetailsExpanded(boolean _expanded) {
        expanded = _expanded;
        return self();
    }
     ...
     * @return this
     */
    public D withHeight(Double _height) {
        height = _height;
        return self();
    }
     ...
     * @return this
     */
    public D withWidth(Double _width) {
        width = _width;
        return self();
    }
     ...
     * @return this
     */
    public D withWindowIcon(List<String> _windowIcon) {
        if (_windowIcon != null) {
     ...
     * @return this
     */
    public D withThrowable(Throwable _throw, String _detailButtonCaption) {
        throwable = _throw;
     ...
     */
    public D withExtendedContent(Collection<String> _lines, String _detailButtonCaption) {
        lines = _lines;
        setDetailButtonCaption(_detailButtonCaption);
        return self();
    }
     ...
     * @return this
     */
    public D showIf(Supplier<Boolean> _condition) {
        doShowIf = _condition;
        return self();
    }
